                ...
                <div class="col-md-7">
                  <div class="regist">
                    ...
                    <p>
                      Contact Person:<br>
                    <p></p>
                    <i class="bi bi-whatsapp" style="font-size: 18px;"></i>&nbsp; 085778157111 (Azka via WhatsApp)<br>
                    <i class="bi bi-line" style="font-size: 18px;"></i>&nbsp; fromanotherside (Nana via LINE)</p><br>

                    <!--<a href="../../Registration/regist_jf.php" class="btn btn-dark" style="width: auto; padding: 8px 15px;">Regist Now !</a>-->
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            ...
            <p>13.00 - 16.40 WIB & 15 Mei 2022</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
      ...
      <div class="row text-center mt-1">
        ...
        <div class="col-md-4 col-lg-4 col-12">
         <img src="../../assets/img/speakers/Artboard 32 copy 3 (1) copy.png" width="500" class="img-fluid">
          ...
          <p class="text-title">Geo Fany Suharwan, M.M.</p>
          <p class="text-body">Head of Product and Marketing Karir.com</p>
        </div>
        ...
        <div class="col-md-4 col-lg-4 col-12">
          ...
          <p class="text-title">Faiza Ummul Husaini, S.Psi.,</p>
          <p class="text-body">Talent Acquistion Specialist Niagahoster</p>
        </div>
        ...
        <div class="col-md-4 col-lg-4 col-12">
          ...
          <p class=" text-title">Lendra Kusuma Wardoyo ST.,</p>
          <p class="text-body">CEO of PT. Solusi Integrasi Teknologi Abadiyah</p>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row text-center mt-1">
          <div class="col-md-6">
            ...
            <p class="text-title">Hans Evan Tatipata</p>
          ...
          <div class="col-md-6">
            ...
            <p class="text-title">Annisa Az-zukhruf</p>
            <p class="text-body">Mahasiswa Universitas Gunadarma</p>
          </div>
        </div>
      </div>
